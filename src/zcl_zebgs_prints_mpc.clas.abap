class ZCL_ZEBGS_PRINTS_MPC definition
  public
...
public section.
  ...
  types:
     TS_TBL_ZEBGS_PRINT type ZEBGS_PRINT .
  types:
TT_TBL_ZEBGS_PRINT type standard table of TS_TBL_ZEBGS_PRINT .
  types:
  ...
  constants GC_TBL_ZEBGS_PRINT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'TBL_ZEBGS_PRINT' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZEBGS_PRINTS_MPC==========CP' ##NO_TEXT.

  methods DEFINE_TBL_ZEBGS_PRINT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZEBGS_PRINTS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEBGS_PRINTS_SRV' ).

define_tbl_zebgs_print( ).
  endmethod.


  method DEFINE_TBL_ZEBGS_PRINT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - TBL_ZEBGS_PRINT
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'TBL_ZEBGS_PRINT' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EMAIL_FILE' iv_abap_fieldname = 'EMAIL_FILE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZEBGS_PRINT'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'TBL_ZEBGS_PRINTSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251001084500'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'TBL_ZEBGS_PRINT'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'EMAIL_FILE'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'TBL_ZEBGS_PRINT'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
